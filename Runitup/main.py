...
from Runitup._telegram import send_to_telegram
from Runitup.constants import LOCAL_SYMBOLS, TELEGRAM_NOTIFICATION_FILE_PATH
from Runitup.data_handling import fetch_and_insert_data
...
def telegram_notify() -> None:
    ...
    row_count = "{:,}".format(get_row_count())
